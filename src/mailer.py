        ...
        try:
            ...
            for recipient in receivers:
                try:
                    ...
                    msg['Subject'] = Header(f"Arxiv LLM Daily 研报 - {datetime.now().strftime('%Y-%m-%d')}", 'utf-8')
    ...
    def send_no_papers_message(self):
        ...
        try:
            ...
            <body style='font-family: Arial, sans-serif; padding: 20px; text-align: center;'>
                ...
                <p style='color: #999; font-size: 14px;'>Arxiv LLM Daily - {datetime.now().strftime('%Y-%m-%d')}</p>
            </body>
            </html>
            """
            ...
            for recipient in receivers:
                try:
                    ...
                    msg['From'] = self.sender_email
                    msg['To'] = recipient
                    msg['Subject'] = Header(f"Arxiv LLM Daily - {datetime.now().strftime('%Y-%m-%d')} (无新论文)", 'utf-8')
